...
To understand the internal software design, script dependencies, or to modify and update the core pipelines, please review the [Code Architecture Guide](/docs/code_architecture.md).
